...
namespace ListoBackend.Controllers
{
    ...
    public class OrdenesController : ControllerBase
    {
        ...
        public OrdenesController(ListoProyectoContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Ordene>> PostOrdene(Ordene ordene)
        {
            ...
            return CreatedAtAction("GetOrdene", new { id = ordene.IdOrd }, ordene);
        }
        ...
        {
            return _context.Ordenes.Any(e => e.IdOrd == id);
        }
    }
}
