...
namespace ListoBackend.Controllers
{
    ...
    public class DomiciliosController : ControllerBase
    {
        ...
        public DomiciliosController(ListoProyectoContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Domicilio>> PostDomicilio(Domicilio domicilio)
        {
            ...
            return CreatedAtAction("GetDomicilio", new { id = domicilio.IdDomicilio }, domicilio);
        }
        ...
        {
            return _context.Domicilios.Any(e => e.IdDomicilio == id);
        }
    }
}
